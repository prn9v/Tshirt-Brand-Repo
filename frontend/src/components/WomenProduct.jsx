...
const WomenProduct = () => {
  ...
  return (
    <div className="min-h-screen bg-green-50 px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-green-800 text-center">Women's Products</h1>
      <div className="flex justify-end mb-6">
        <select
          className="w-full sm:w-auto border-2 border-green-300 rounded-full px-4 py-2 bg-white text-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 text-sm sm:text-base"
          value={sortBy}
